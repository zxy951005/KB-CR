...
#import coref_model_KB as cm
import coref_model_KB_SFA as cm
#import coref_model_KB_CRAFT as cm
#import coref_model_KB_SFA_CRAFT as cm
...
if __name__ == "__main__":
  ...
  with tf.Session() as session:
    ...
    writer = tf.summary.FileWriter(log_dir, graph=session.graph, flush_secs=20)
