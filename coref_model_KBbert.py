...
class CorefModel(object):
    ...
    def tensorize_example(self, example, is_training):
        ...
        example_tensors = (tokens, context_word_emb, head_word_emb, lm_emb, bert_emb,char_index, text_len, is_training, gold_starts, gold_ends, cluster_ids,  context_OMCS_emb, context_organisms_emb, context_proteins_emb, context_mygenes_emb, context_genes_emb, context_interaction_types_emb, context_allkb_emb)
    ...
    def truncate_example(self, tokens, context_word_emb, head_word_emb, lm_emb, bert_emb,char_index, text_len, is_training, gold_starts, gold_ends, cluster_ids, OMCS_emb, organisms_emb, proteins_emb, mygenes_emb, genes_emb,interaction_types_emb,allkb_emb):
        ...
        return  tokens, context_word_emb, head_word_emb, lm_emb, bert_emb,char_index, text_len, is_training, gold_starts, gold_ends, cluster_ids,OMCS_emb, organisms_emb, proteins_emb, mygenes_emb, genes_emb,interaction_types_emb, allkb_emb
...
#         return 1 - (tf.to_float(is_training) * dropout_rate)
    ...
    def get_predictions_and_loss(self, tokens, context_word_emb, head_word_emb, lm_emb, bert_emb,char_index, text_len, is_training, gold_starts, gold_ends, cluster_ids, OMCS_emb, organisms_emb, proteins_emb, mygenes_emb, genes_emb, interaction_types_emb, allkb_emb):
    ...
    def evaluate(self, session, official_stdout=False):
        ...
        for example_num, (tensorized_example, example) in enumerate(self.eval_data):
            # 👇，最后多了三个_
            _, _, _, _, _, _, _, _,  gold_starts, gold_ends, _, _ , _, _, _ ,_, _, _= tensorized_example
